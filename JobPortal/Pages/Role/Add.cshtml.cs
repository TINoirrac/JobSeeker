...
namespace JobPortal.Areas.Admin.Pages.Role
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostStartUpdate()
        {
            ...
            var result = await _roleManager.FindByIdAsync(Input.Name);
            if (result != null)
            {
            ...
            {
                StatusMessage = "Error: Không có thông tin về Role ID = " + Input.Name;
            }
