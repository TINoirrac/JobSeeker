...
namespace JobPortal.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        private readonly JobPortalWebContext _webContext;

        public LoginModel(UserManager<UserProfile> userManager, SignInManager<UserProfile> signInManager, ILogger<LoginModel> logger, JobPortalWebContext webContext)
        {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Chưa nhập username hoặc email")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            //var data = _webContext.UserProfiles.Where(s => s.UserName.Equals(Input.UserNameOrEmail)).ToList();
